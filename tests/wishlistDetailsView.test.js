...
describe("wishlist owner detail", () => {
  ...
  it("shows a neutral empty state without invented creation actions", async () => {
    ...
    expect(ui.view.textContent).not.toContain("Ajouter un cadeau"); expect(ui.view.querySelector("button")?.textContent).toBe("Actualiser les cadeaux");
  });
