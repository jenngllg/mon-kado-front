...
describe("application shell", () => {
  ...
  it.each([
    ...
    if ([RouteNames.Lists, RouteNames.NewList, RouteNames.EditList, RouteNames.DeleteList, RouteNames.NewWish, RouteNames.ListDetails, RouteNames.Reservations].some(name => name === routeName)) {
