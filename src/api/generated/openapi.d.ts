...
export interface paths {
    readonly "/api/v1/admin/members/{memberId}/data-exports": {
        ...
        readonly put?: never;
        /**
         * Requests or reuses a member's ZIP and durably records the administrative request.
         * @description Requires a technical requestReference of at most 128 characters without control characters or personal data.
        ...
        readonly post: {
            readonly parameters: {
                ...
                readonly header?: never;
                readonly path: {
                    /** @description The target member identifier. */
            ...
            readonly requestBody: {
                readonly content: {
                    readonly "application/*+json": components["schemas"]["RequestAdministrativeDataExportRequest"];
                    readonly "application/json": components["schemas"]["RequestAdministrativeDataExportRequest"];
                };
            };
            readonly responses: {
    ...
    readonly "/api/v1/admin/members/{memberId}/data-exports/{exportId}": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /** Gets one retained export with an existing administrative request. */
        readonly get: {
            readonly parameters: {
                readonly query?: never;
                readonly header?: never;
    ...
    readonly "/api/v1/admin/members/{memberId}/data-exports/{exportId}/archive": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /**
         * Downloads an administratively requested archive after durable release auditing.
         * @description Requires a live database-backed administrator role on every request. No public or signed download URL exists.
    ...
    readonly "/api/v1/admin/members/{memberId}/data-exports/latest": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /** Gets the latest retained export requested administratively for the member. */
        readonly get: {
            readonly parameters: {
                readonly query?: never;
                readonly header?: never;
    ...
    readonly "/api/v1/admin/reported-wishlists": {
        ...
        /** Lists reported wishlists, counting and ordering only reports matching the status and reason filters. */
        readonly get: {
            readonly parameters: {
                readonly query?: {
                    ...
                    /** @description The disposition filter, defaulting to pending; all includes processed reports. */
                    readonly status?: components["schemas"]["WishlistReportStatusFilter"];
                };
                readonly header?: never;
                readonly path?: never;
                readonly cookie?: never;
    ...
    readonly "/api/v1/admin/reported-wishlists/{wishlistId}/reports/{reportId}": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /** Reads a report in any disposition and its own ETag, independently of the wishlist version. */
        readonly get: {
            readonly parameters: {
                readonly query?: never;
                readonly header?: never;
            ...
            readonly responses: {
                ...
                readonly 200: {
                    ...
                    content: {
                        readonly "application/json": components["schemas"]["WishlistReportDetails"];
                    };
                };
                /** @description Bad Request */
                readonly 400: {
        ...
        /** Reviews, corrects, or reopens one report without changing wishlist moderation or sending notifications. */
        readonly put: {
            readonly parameters: {
                readonly query?: never;
                readonly header: {
            ...
            readonly requestBody: {
                readonly content: {
                    readonly "application/*+json": components["schemas"]["UpdateWishlistReportReviewRequest"];
                    readonly "application/json": components["schemas"]["UpdateWishlistReportReviewRequest"];
                };
            };
            readonly responses: {
    ...
    readonly "/api/v1/admin/reported-wishlists/{wishlistId}/reports/{reportId}/events": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /** Reads the private history of one report, including corrections and reopening. */
        readonly get: {
            readonly parameters: {
                readonly query?: {
                    /** @description The optional one-based page, defaulting to one. */
                    readonly page?: number | string;
            ...
            readonly responses: {
                ...
                readonly 200: {
                    ...
                    content: {
                        readonly "application/json": components["schemas"]["PaginatedResponseOfWishlistReportReviewEventDetails"];
                    };
                };
                /** @description Bad Request */
                readonly 400: {
    ...
    readonly "/api/v1/members/{memberId}/profile/image": {
        ...
        /** Reads the current public photo of a confirmed member; old photo URLs return 404. */
        readonly get: {
            readonly parameters: {
                readonly query?: {
                    /** @description The current photo identifier from its versioned URL. */
                    readonly imageId?: string;
                };
                readonly header?: never;
                readonly path: {
                    /** @description The public member identifier. */
                    readonly memberId: string;
                };
                readonly cookie?: never;
            };
            ...
            readonly responses: {
                ...
                readonly 200: {
                    ...
                    content: {
                        readonly "image/webp": components["schemas"]["FileStreamResult"];
                    };
                };
                /** @description Bad Request */
                readonly 400: {
    ...
    readonly "/api/v1/members/current/deletion-requests": {
        ...
        readonly get?: never;
        readonly put?: never;
        /** Requests an email confirmation before permanently deleting the current account. */
        readonly post: {
            readonly parameters: {
                readonly query?: never;
                readonly header?: never;
    ...
    readonly "/api/v1/members/current/deletion-requests/confirm": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly get?: never;
        readonly put?: never;
        /** Permanently deletes the current account after explicit email confirmation. */
        readonly post: {
            readonly parameters: {
                readonly query?: never;
                readonly header?: never;
            ...
            readonly requestBody: {
                readonly content: {
                    readonly "application/*+json": components["schemas"]["ConfirmMemberAccountDeletionRequest"];
                    readonly "application/json": components["schemas"]["ConfirmMemberAccountDeletionRequest"];
                };
            };
            readonly responses: {
    ...
    readonly "/api/v1/members/current/profile/image": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly get?: never;
        /** Adds or replaces the current member's public profile photo. */
        readonly put: {
            readonly parameters: {
                readonly query?: never;
                readonly header: {
            ...
            readonly requestBody: {
                readonly content: {
                    readonly "multipart/form-data": {
                        /**
                         * Format: binary
                         * @description A JPEG, PNG, or non-animated WebP image of at most 10 MiB. The declared filename and media type are not trusted.
                         */
        ...
        readonly post?: never;
        /** Removes the current member's photo and schedules durable file cleanup. */
        readonly delete: {
            readonly parameters: {
                readonly query?: never;
                readonly header: {
    ...
    readonly "/api/v1/shared-wishlists/{shareLinkId}/wishes/{wishId}/image": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly get: {
            readonly parameters: {
                readonly query?: {
                    /** @description The short-lived signed bearer grant. */
                    readonly token?: string;
                };
                readonly header?: never;
                readonly path: {
                    /** @description The share-link identifier. */
                    readonly shareLinkId: string;
                    /** @description The gift-wish identifier. */
                    readonly wishId: string;
                };
    ...
    readonly "/api/v1/wishlists/{wishlistId}/wish-import-previews": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
         ...
         * @description Partial extraction returns warnings and editable suggestions. Keep this response only in memory.
        ...
        readonly post: {
            readonly parameters: {
                ...
                readonly header?: never;
                readonly path: {
                    /** @description The owned parent wishlist. */
                    readonly wishlistId: string;
                };
                readonly cookie?: never;
            };
            ...
            readonly requestBody: {
                readonly content: {
                    readonly "application/*+json": components["schemas"]["CreateWishImportPreviewRequest"];
                    readonly "application/json": components["schemas"]["CreateWishImportPreviewRequest"];
                };
            };
            readonly responses: {
                ...
                readonly 200: {
                    ...
                    content: {
                        readonly "application/json": components["schemas"]["WishImportPreview"];
                    };
                };
                /** @description Bad Request */
                readonly 400: {
    ...
    readonly "/api/v1/wishlists/{wishlistId}/wishes/{wishId}/image": {
        ...
        readonly post?: never;
        /** Removes an image from an owned gift wish. */
        readonly delete: {
            readonly parameters: {
                readonly query?: never;
                readonly header: {
...
export interface components {
    schemas: {
        ...
        /** @description Contains the token explicitly submitted to confirm account deletion. */
        readonly ConfirmMemberAccountDeletionRequest: {
            /** @description Gets the protected confirmation token. */
            readonly token: null | string;
        };
        ...
        readonly EntityTagHeaderValue: {
            readonly isWeak?: boolean;
            readonly tag?: components["schemas"]["StringSegment"];
        };
        ...
        readonly FileStreamResult: {
            ...
            readonly entityTag?: null | components["schemas"]["EntityTagHeaderValue"];
            readonly fileDownloadName?: null | string;
            readonly fileStream?: components["schemas"]["Stream"];
            /** Format: date-time */
            readonly lastModified?: null | string;
        };
        ...
        /** @description Represents one page of API results. */
        readonly PaginatedResponseOfWishlistReportReviewEventDetails: {
            /**
             * Format: int32
             * @description Gets the requested one-based page number.
             */
            ...
            readonly hasPreviousPage?: boolean;
            /** @description Gets the current page items. */
            readonly items: readonly components["schemas"]["WishlistReportReviewEventDetails"][];
            /**
             * Format: int32
             * @description Gets the requested page size.
             */
        ...
        /** @description Identifies the external request requiring an administrative data export. */
        readonly RequestAdministrativeDataExportRequest: {
            /** @description Gets the mandatory technical request reference, without personal information. */
            readonly requestReference?: null | string;
        };
        ...
        readonly StringSegment: {
            readonly buffer?: null | string;
        ...
        /** @description Requests a report disposition and optional private note. */
        readonly UpdateWishlistReportReviewRequest: {
            /** @description Gets the optional private note; omission clears the current note. */
            readonly reviewNote?: null | string;
            readonly status?: null | components["schemas"]["WishlistReportStatus"];
        };
        ...
        readonly UserSearchResponse: {
             ...
             */
            readonly id: string;
            /** @description Gets the public profile-photo URL, or null for a generated avatar based on Id. */
            readonly profileImageUrl?: null | string;
        };
        ...
        /** @description Contains normalized image bytes for a client-side preview. */
        readonly WishImportImage: {
            /** @description Gets the Base64-encoded WebP content. */
            readonly contentBase64?: null | string;
            /** @description Gets the image media type. */
            readonly contentType?: null | string;
        };
        /** @description Contains editable suggestions without creating a gift wish. */
        readonly WishImportPreview: {
            readonly image?: null | components["schemas"]["WishImportImage"];
            /** @description Gets the suggested gift name. */
            readonly name?: null | string;
            /**
             * Format: double
             * @description Gets the unambiguous price in euros.
             */
            readonly price?: null | number | string;
            /**
             * Format: int32
             * @description Gets the initial requested quantity.
             */
            readonly quantity?: number | string;
            /** @description Gets the original product URL. */
            readonly url?: null | string;
            /** @description Gets stable warning codes for incomplete extraction. */
        ...
        readonly WishlistReportDetails: {
            ...
            /**
             * Format: date-time
             * @description Gets the latest UTC review date.
             */
            readonly reviewedAt?: null | string;
            /**
             * Format: uuid
             * @description Gets the latest deciding administrator, or null after account deletion.
             */
            readonly reviewedByAdministratorId?: null | string;
            /** @description Gets the latest private review note. */
            readonly reviewNote?: null | string;
            /** @description Gets the current disposition. */
            readonly status?: components["schemas"]["WishlistReportStatus"];
        };
        /** @enum {string} */
        readonly WishlistReportReason: "spamOrScam" | "inappropriateContent" | "privacyViolation" | "other";
        /** @description Contains private administrative report review data. */
        readonly WishlistReportReviewEventDetails: {
            /**
             * Format: uuid
             * @description The administrator identifier, or null after deletion.
             */
            readonly administratorId?: null | string;
            /**
             * Format: uuid
             * @description The review event identifier.
             */
            readonly id?: string;
            /** @description The optional private note. */
            readonly note?: null | string;
            /**
             * Format: date-time
             * @description The UTC review date.
             */
            readonly occurredAt?: string;
            /** @description The previous disposition. */
            readonly previousStatus?: components["schemas"]["WishlistReportStatus"];
            /** @description The new disposition. */
            readonly status?: components["schemas"]["WishlistReportStatus"];
        };
        /**
         * @description Identifies the current administrative disposition of a report.
         * @enum {string}
         */
        readonly WishlistReportStatus: "pending" | "upheld" | "dismissed";
        /** @enum {string} */
        readonly WishlistReportStatusFilter: "pending" | "upheld" | "dismissed" | "all";
